...
# (MyBestFriend)
# LowerCamelCase: 이어지는 단어의 첫글자만 대문자로 작성
# (myBestFriend)
...
print(waffle) # <__main__.WaffleMachine object at 0x0000024136D38510>
# : 0x0000024136D38510주소에 저장된 WaffleMachine 객체