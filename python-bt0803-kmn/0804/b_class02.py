...
#? 2-1. 인스턴스 변수
# : 클래스를 기반으로 만들어지는 모든 인스턴스(객체)들이 각각 #ㅏ로 저장하는 변수
# : 클래스 내에 정의 되지만 각 클래스 인스턴스(객체)에서 개별적으로 가지는 변수
# : 각 객체의 상태 저장
...
class Person:
    ...
    def who_am_i(self, name, age, tel, address):
        ...
        # 우항의 name은 매개변수 name
        # who_am_i()메서드를 호출 할 때 전달된 name이 인스턴스의 name이 된다.
...
print(seungah.tel)
print(seungah.adress)

junGook = Person()
junGook.who_am_1('junGook', '010-1111-2222', '부산시')