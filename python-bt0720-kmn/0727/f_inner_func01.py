### 내장 함수(built0-in Function)

# 내장 함수: 파이썬(프로그램)이 기본적으로 제공하는 함수
#              별도의 라이브러리나 모듈을 불러오지 않고도 사용가능
# p.146

# 문자열 내장 함수

# 1. chr() 함수
# : 문자 자신만이 가지는 코드 값(문자 코드)를 반환
# : 미국 표준 코드(아스키코드), 국제 표준 코드(유니코드) 등이 있다
...
print(format(10000,'_')) # 숫자를 천 단위로 표현할 때 사용
