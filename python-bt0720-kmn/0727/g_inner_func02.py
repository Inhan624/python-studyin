...
# 4. max() & min()
# max(iterable) 또는 max(데이터 1, 데이터 2,...) 중에서 가장 큰 값을 반환
...
# sum()
# sum(iterable, start): iterable의 모든 항목과 시작값을 더한 결과 반환
# start 생략시 iterable값들만을 더한 결과를 반환
