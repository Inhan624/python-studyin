...
# 2. count() 메소드: 특정문자나 문자열이 등장하는 횟수를 세는 데 사용
...
# 4. index() 메소트: 특정 문자나 문자열이 처음 등장하는 인덱스를 반환
...
print('   Hello   '.strip()) # 문자열 양쪽 끝은 공백 및 다른 특정 문자를 제거
print('   Hello   '.lstrip()) 
print('   Hello   '.rstrip())