...
3. if문의 맨 끝에는 조건 뒤에 콜론(:)을 반드시 기제
'''
...
if num > 10:
    print('The number is great than 10.')

# 3. else 문
# if문의 조건이 충족되지 않을때(즉, if문의 조건이 False일 때) 실행되는 코드 블록을 지정
'''
if 조건:
    실행할 코드
else:
...
if 조건1:
    ...
    실행할 코드2(조건1이 거짓이고, 조건2가 참일때 실행할 코드)
...
elif 조건 999
    실행할 코드 999
else:
...
#삼항연산자
#value_if_ture(실행할 코드) if condition(조건) else value_if_false(실행될 코드-거짓)
