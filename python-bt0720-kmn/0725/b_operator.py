# 연산자(operator)
# : 특정작업을 수행하는데 사용되는 특수 기호나 구문

# 항목의 개수: 단항, 이항, 삼항 연산자로 구분
# 사용목적: 산술, 대입, 관계 논리 연산자로 구분
...
print(a - b) # 뺄셈: 2
print(a * b) # 곱셈: 15
print(a / b) # 나눗셈: 1.66666666666666666666666666...
...
# : 모든 조건이 False일 때만 False를 변환

print(not a) #False
# not 연산자는 boolean 값을 반전

print('================================================')
# 변수 'a'와  'b'에 각각 10과 5를 할당하고, 그 함을 변수 'c'에 저장한 후 출력하세요.
a = 10
b = 5
c = a + b
print(c)
